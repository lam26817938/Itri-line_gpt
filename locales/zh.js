const zh = {
  ...
  __COMMAND_BOT_DEACTIVATE_ALIASES: ['閉嘴', '停止說話','軟體科技業','製造或營造業','技術服務業','醫療生技業','教育服務業','藝術`娛樂休閒業','運輸物流業','金融保險業','零售批發業','客戶服務','業務/行銷人員','財會/行政人員','研發工程師','產線/物流工程師',
                                    '顯示更多', 'AOI瑕疵分類','備料預測','銷量預測','交貨量預測','推薦系統','售價訂定','員工離職預測','載客熱點預測','景點人數預測','馬拉松運動博覽會參訪動線類別預測','疾病風險預測',
                                    '員工表現評估','房價預測','Data Refine','資料標註','時序預測','影像分類','腦腫瘤分割','農產品瑕疵檢測','台灣牧場乳量預測','糖尿病視網膜病變影像判讀',
                                  '智慧建築','循環材料辨識','景點人數預測', '進行資料盤點','推薦方案','常見問答','硬體需求','資料準備需求','系統相關問題','功能說明','FAST AI介紹'],
  ...
  __COMMAND_SYS_DOC_LABEL: 'Demo影片觀看',
  __COMMAND_SYS_DOC_TEXT: 'Demo影片觀看',
  __COMMAND_SYS_DEPLOY_LABEL: '重新啟動',
  __COMMAND_SYS_DEPLOY_TEXT: '重新啟動',
  __COMMAND_SYS_DEPLOY_REPLY: '正在重新啟動',
  __COMMAND_SYS_REPORT_LABEL: 'FAST AI介紹',
  __COMMAND_SYS_REPORT_TEXT: 'FAST AI介紹',
  __COMMAND_SYS_VERSION_LABEL: '了解更多',
  __COMMAND_SYS_VERSION_TEXT: '了解更多',
